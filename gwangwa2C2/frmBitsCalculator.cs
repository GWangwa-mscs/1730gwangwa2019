...
namespace gwangwa2C2
{
    public partial class frmBitsCalculator : Form
    {
        ...
        public frmBitsCalculator()
        {
            InitializeComponent();
        }
          /*when you want to change the name of a variable you can use
            'CTRL H' to easily and quickly search and replace a variable
            the b-c section next to the replace box at the bottom of the find box
            is used to find the next variable with the same name and replace.
           */
           /*Note: The use of checked(); instead of convert.ToInt32 or ToInt64
             is because the sign used is an int calculation after the short and 
             the checked is added s an overflow correction so we get error instead 
             of resetting the count to -1234567 it statess error
            */
        ...
        private void input1TextBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                decimal1TextBox.Text = "error";
                decimal1 = 0m;
            }

        }

        private void inpu2TextBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void addButton_Click_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ushort3TextBox.Text = this.ushort3.ToString();
            }
